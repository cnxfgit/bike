...
a:hover {color:#FF6600; text-decoration: underline;}
  ...
  <body>
  <c:choose>
  	<c:when test="${code eq 'success' }"><!-- 如果成功显示成功的图片 -->
...
<div class="divBody">
	...
	<div class="divContent">
	  <div style="margin: 20px;">
		...
		<br/>
		<br/>
		<span style="margin-left: 50px;"><a target="_top" href="<c:url value='/jsp/user/userLogin.jsp'/>">登录</a></span>
		<span style="margin-left: 50px;"><a target="_top" href="<c:url value='/jsp/index.jsp'/>">主页</a></span>
	  	<span style="margin-left: 50px;"><a target="_top" href="<c:url value='/jsp/user/userRegist.jsp'/>">返回注册</a></span>
	  </div>
	</div>
</div>
